...
ActiveRecord::Schema.define(version: 20140825141578) do
  ...
  add_index "cms_blog_translations", ["cms_blog_id"], name: "index_cms_blog_translations_on_cms_blog_id", using: :btree
  ...
  add_index "cms_blogs", ["published"], name: "cms_blogs_published_index", using: :btree
  add_index "cms_blogs", ["slug"], name: "blogname_key", using: :btree
  ...
  add_index "cms_contentitem_translations", ["cms_contentitem_id"], name: "index_072c3a76f87c96e2f91149eccd2a283dca2b613f", using: :btree
  ...
  add_index "cms_contentitems", ["account_id"], name: "index_cms_contentitems_on_account_id", using: :btree
  add_index "cms_contentitems", ["cms_page_id"], name: "cms_contentitems_cms_page_id_index", using: :btree
  ...
  add_index "cms_media_file_translations", ["cms_media_file_id"], name: "index_cms_media_file_translations_on_cms_media_file_id", using: :btree
  ...
  add_index "cms_media_files", ["media", "folder", "account_id"], name: "index_media_folder_account_id", unique: true, using: :btree
  ...
  add_index "cms_pages", ["account_id"], name: "index_cms_pages_on_account_id", using: :btree
  add_index "cms_pages", ["ancestry"], name: "index_cms_pages_on_ancestry", using: :btree
  add_index "cms_pages", ["ancestry_depth"], name: "index_cms_pages_on_ancestry_depth", using: :btree
  add_index "cms_pages", ["published"], name: "cms_pages_published_index", using: :btree
  add_index "cms_pages", ["slug"], name: "pagename_key", using: :btree
  ...
  add_index "cms_post_translations", ["cms_post_id"], name: "index_cms_post_translations_on_cms_post_id", using: :btree
  ...
  add_index "cms_posts", ["published_on"], name: "cms_posts_published_index", using: :btree
  add_index "cms_posts", ["slug"], name: "postname_key", using: :btree
  ...
  add_index "cms_snippet_translations", ["cms_snippet_id"], name: "index_cms_snippet_translations_on_cms_snippet_id", using: :btree
  ...
  add_index "cms_snippets", ["account_id"], name: "index_cms_snippets_on_account_id", using: :btree
  add_index "cms_snippets", ["slug"], name: "index_cms_snippets_on_slug", using: :btree
  ...
  add_index "core_activities", ["account_id"], name: "index_core_activities_on_account_id", using: :btree
  add_index "core_activities", ["user_id"], name: "index_core_activities_on_user_id", using: :btree
  ...
  add_index "core_addresses", ["addressable_type", "addressable_id"], name: "index_core_addresses_on_addressable_type_and_addressable_id", unique: true, using: :btree
  ...
  add_index "core_category_translations", ["core_category_id"], name: "index_category_translation", using: :btree
  ...
  add_index "core_custom_field_def_translations", ["core_custom_field_def_id"], name: "core_custom_field_def_translations_index", using: :btree
  ...
  add_index "core_custom_field_defs", ["account_id"], name: "index_core_custom_field_defs_on_account_id", using: :btree
  add_index "core_custom_field_defs", ["owner_id", "owner_type"], name: "index_core_custom_field_defs_on_owner_id_and_owner_type", using: :btree
  ...
  add_index "core_custom_fields", ["account_id"], name: "index_core_custom_fields_on_account_id", using: :btree
  add_index "core_custom_fields", ["owner_id", "owner_type"], name: "index_core_custom_fields_on_owner_id_and_owner_type", using: :btree
  ...
  add_index "core_payment_histories", ["anchor_id"], name: "index_payment_histories_on_anchor_id", using: :btree
  add_index "core_payment_histories", ["item_ref"], name: "index_payment_histories_on_item_ref", using: :btree
  add_index "core_payment_histories", ["order_ref"], name: "index_payment_histories_on_order_ref", using: :btree
  add_index "core_payment_histories", ["owner_id"], name: "index_payment_histories_on_owner_id", using: :btree
  add_index "core_payment_histories", ["owner_type"], name: "index_payment_histories_on_owner_type", using: :btree
  ...
  add_index "globalize_countries", ["code"], name: "index_globalize_countries_on_code", using: :btree
  add_index "globalize_countries", ["locale"], name: "index_globalize_countries_on_locale", using: :btree
  ...
  add_index "globalize_languages", ["iso_639_1"], name: "index_globalize_languages_on_iso_639_1", using: :btree
  add_index "globalize_languages", ["iso_639_2"], name: "index_globalize_languages_on_iso_639_2", using: :btree
  add_index "globalize_languages", ["iso_639_3"], name: "index_globalize_languages_on_iso_639_3", using: :btree
  add_index "globalize_languages", ["rfc_3066"], name: "index_globalize_languages_on_rfc_3066", using: :btree
  ...
  add_index "user_site_profiles", ["uuid"], name: "index_user_site_profiles_on_uuid", using: :btree
